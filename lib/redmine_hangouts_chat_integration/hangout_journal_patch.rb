...
module RedmineHangoutsChatIntegration
  module JournalPatch
    ...
    def self.included(base) # :nodoc:
      ...
      base.class_eval do
        after_create :hangout_issue_edit
      end
    end
    ...
    def hangout_issue_edit
      send_hangout_issue_edit(self)
    end

    private

    def send_hangout_issue_edit(journal)
...
Journal.send(:include, RedmineHangoutsChatIntegration::JournalPatch) unless Journal.included_modules.include? RedmineHangoutsChatIntegration::JournalPatch
#RedmineExtensions::PatchManager.register_model_patch 'Issue', 'RedmineHangoutsChatIntegration::JournalPatch'
